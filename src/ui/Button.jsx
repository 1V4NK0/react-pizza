...
function Button({ children, disabled, type, to, onClick }) {
  ...
  const styles = {
    ...
    secondary:
      " text-sm px-4 py-2.5 md:px-6 md-py-3.5 border-2 border-stone-300 disabled:cursor-not-allowed  focus:outline-none focus:ring focus:ring-yellow-700 duration-300  uppercase hover:bg-stone-700 transition-colors font-semibold inline-block tracking-wide rounded-2xl text-stone-500",
